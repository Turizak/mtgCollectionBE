...
const createAccount = `
                    INSERT INTO 
                            account (first_name, last_name, username, password) 
                    VALUES 
                            ($1, $2, $3, $4)
                    `;
...
const addAccountCards = `
                    INSERT INTO 
                            cards (account_id, scry_id, card_name, price, quantity) 
                    VALUES 
                            ($1, $2, $3, $4, $5)
                    `;
...
const updateAccountCards = `
                    UPDATE 
                            cards 
                    SET 
                            card_name = $3, price = $4, quantity= $5 
                    WHERE 
                            account_id = $1 
                    AND 
                            scry_id = $2
